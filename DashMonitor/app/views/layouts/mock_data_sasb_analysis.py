...
headers = [
    ...
    html.P(className="align-center align-middle text-ssindex-poor mb-0", children=html.Div(children=[html.P(className="m-0 text-center", children="Poor"), html.P(className='fw-normal m-0 fs-7 text-dark',children="0-19%")])),
    html.P(className="align-center text-ssindex-low mb-0", children=html.Div(children=[html.P(className="m-0 text-center", children="Low"), html.P(className='fw-normal m-0 fs-7 text-dark',children="20-39%")])),
    html.P(className="align-center text-ssindex-average mb-0", children=html.Div(children=[html.P(className="m-0 text-center", children="Average"), html.P(className='fw-normal m-0 fs-7 text-dark',children="40-59%")])),
    html.P(className="align-center text-ssindex-good mb-0", children=html.Div(children=[html.P(className="m-0 text-center", children="Good"), html.P(className='fw-normal m-0 fs-7 text-dark',children="60-79%")])),
    html.P(className="align-center text-ssindex-excellent mb-0", children=html.Div(children=[html.P(className="m-0 text-center", children="Excellent"), html.P(className='fw-normal m-0 fs-7 text-dark',children="80-100%")])),
    "Score",
    html.P(className="align-center mb-0", children=html.Div(children=[html.P(className="m-0 text-center", children="Percentil"), html.P(className='fw-normal m-0 fs-7 text-dark',children="Local Industry")])),
]
